  ...
  return (
    <div>
      <div className="homePageSection">
        <div className="homeProfile">
          <div className="homeProfileContainer">
            ...
            <h2>
              ...
              nikhiljalandhra@gmail.com
            </h2>
            <h2>
              <span>
                <IoLogoLinkedin />
              </span>
              <Link href="https://www.linkedin.com/in/nikhil-jalandhra-1479742b0/">
                linkedin
              </Link>
            </h2>
            <h2>
              ...
              <Link href="https://github.com/Nikhil-Jalandhra">git-hub</Link>
            </h2>
            <div className="homeDivider"></div>
            <div className="homeSkillsSection">
              <h2 className="homeSkillDisclamer">
                Skills <span>(hover more details)</span>
              </h2>
              <h2 className="homeSkillDisclamerResponsive">
                Skills <span>(click more details)</span>
              </h2>
              <div className="homeSkillsContainer">
                {SkillsArray.map((item, index) => (
                  <div
                    className="skillImageContainer toolTipParent"
                    key={item.name}>
        ...
        <div className="homeDynamic">{children}</div>
      </div>
    </div>
  );
}
